    ...
    <div id="home" className="grid-cols-1 scroll-mt-20 sm:grid sm:grid-cols-2 sm:px-44 sm:py-34  gap-4 sm:gap-80 sm:text-start  sm:items-center  py-18 text-center ">
      <div className="flex flex-col gap-7 sm:w-200">
        ...
        >
          <div className="flex gap-4 justify-center ">
            ...
            <button className="bg-white py-2.75 px-4 hover:scale-103 shadow-lg/45 shadow-gray-300 hover:shadow-lg/65 text-gray dark:text-white dark:shadow-blue-950 dark:border border-blue-950 dark:bg-transparent font-medium rounded-xl">
              <a href="#projects">View Projects</a>
            </button>
          </div>
          <div className="flex gap-8 justify-center pb-6 pt-8">
            <a className="hover:scale-125 transition-all " href="https://github.com/elmira1385/">
            ...
            <a className="hover:scale-125 transition-all "  href="elmirashokriyan64@gmail.com">
              <svg className="hover:stroke-[#2662d9] hover:rotate-12 transition-all "
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
      ...
      <motion.div initial={{
          ...
          transition={{
            duration: 0.4,
            delay: 0.4,
          }} className="relative pt-86 flex sm:justify-self-end sm:pr-105">
        ...
        <div className="bg-white hover:shadow-2xl/60 sm:w-110 flex flex-col gap-6 hover:scale-102 p-6 dark:border-2 border-gray-800 shadow-[#c2d6fc] dark:shadow-[#12316a]  dark:bg-[#0D111F] w-90 h-77 absolute top-[50%] left-[50%] rounded-2xl z-10 -translate-1/2">
          ...
          <div className="flex flex-col gap-2 justify-start items-start">
            ...
            <p className="text-[#AC63EF] text-sm sm:pl-6">skills: <span className="text-[#FA9753]">[</span><span className="text-[#16A34A]">'Git'</span> , <span className="text-[#16A34A]">'Html'</span>  ,  <span className="text-[#16A34A]">'Css'</span> ,  <span className="text-[#16A34A]">'JavaScript'</span> ,  <span className="text-[#16A34A]">'TypeScript'</span> , <span className="text-[#16A34A]">'React'</span>  ,  <span className="text-[#16A34A]">'Next.Js'</span> <span className="text-[#FA9753]">]</span> , </p>
            <p className="text-[#AC63EF] text-sm pl-5 sm:pl-6">focuses: <span className="text-[#FA9753]">[</span><span className="text-[#16A34A]">'Frontend'</span> <span className="text-[#FA9753]">]</span> , </p>
